    ...
    namespace detail
    {
        ...
        class SessionImpl
        {
            public:
                ...
                //Functionality
                void fetch_buffer( const std::size_t length, const std::shared_ptr<Bytes> buffer, const std::shared_ptr< Session > session, const std::function< void ( const std::shared_ptr< Session >, const Bytes& ) >& callback ) const;
